...
def validate_pricing_compliance(**context):
    ...
    # Configuration deployed via CR-2026-0891 (weekly pricing rules update)
    compliance_config = '''{
    ...
    logger.info(f"[validate_pricing_compliance] Validating against {len(rules)} rule categories")
